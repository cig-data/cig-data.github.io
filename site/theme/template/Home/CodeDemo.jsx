...
class CodeDemo extends React.PureComponent {
  ...
  constructor(props) {
    super(props);
    const businessDemo = props.pageData['business'];
    // console.log(props.pageData);
    // console.log(props.pageData['basic']);
    this.state = {
      code: props.utils
        .toReactComponent(businessDemo.colour.highlightedCode),
      component: businessDemo.colour.preview(React, ReactDom),
      replay: false,
      isMobile: false,
      openCode: false,
    };
